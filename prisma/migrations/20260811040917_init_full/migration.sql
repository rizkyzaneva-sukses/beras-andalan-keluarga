...
CREATE TABLE "produk" (
    ...
    "hpp_rata_rata" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "pembelanjaan" (
    ...
    "status_bayar" TEXT NOT NULL DEFAULT 'CASH',
...
CREATE TABLE "pembayaran_utang" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "pembelanjaan_id" TEXT NOT NULL,
    "jumlah" INTEGER NOT NULL,
    "tanggal" DATETIME NOT NULL,
    "created_by" TEXT NOT NULL,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "pembayaran_utang_pembelanjaan_id_fkey" FOREIGN KEY ("pembelanjaan_id") REFERENCES "pembelanjaan" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "pembayaran_utang_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "user" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
